export default {
  ...
  'common.delete': 'Xóa',
  'common.confirm.content.delete': 'Tài khoản này sẽ bị khóa và không thể sử dụng',
  'common.confirm.title.delete': 'Xác nhận xóa đối tượng',
  'common.delete.one': 'Chỉ xóa được một đối tượng',
  'common.share': 'Chia sẻ',
  'common.listen': 'Nghe',
  'common.statusActive': 'Đang hoạt động',
  'common.add': 'Thêm',
  'common.edit': 'Sửa',
  'common.answer': 'Trả lời',
  'common.all': 'Tất cả',
  ...
  'common.input.notEmpty': 'Không được để trống',
  ...
  'common.status.param':
    '{status,select, false {Không hoạt động} true {Hoạt động}  other {Không xác định}}',
  ...
  'common.page': 'Trang',
  'common.video.upload': 'Vui lòng tải video của bạn lên',
